...
class TicketController extends Controller
{
    ...
    public function index()
    {
        ...
        ->select('games.id as id','games.title as Juego','games.sinopsis as Sinopsis','games.platform as plataforma','games.classification as clasificacion','games.developer as Desarrolladora','games.releaseDay as salida_de_juego',
